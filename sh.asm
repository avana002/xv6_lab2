...
runcmd(struct cmd *cmd)
{
  ...
  switch(cmd->type){
      ...
      1b:	8b 04 85 3c 17 00 00 	mov    0x173c(,%eax,4),%eax
      22:	ff e0                	jmp    *%eax
  default:
    panic("runcmd");
      24:	c7 04 24 10 17 00 00 	movl   $0x1710,(%esp)
  ...
  case EXEC:
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      67:	c7 44 24 04 17 17 00 	movl   $0x1717,0x4(%esp)
      6e:	00 
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
      ...
      ba:	c7 44 24 04 27 17 00 	movl   $0x1727,0x4(%esp)
      c1:	00 
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     12e:	79 0c                	jns    13c <runcmd+0x13c>
      panic("pipe");
     130:	c7 04 24 37 17 00 00 	movl   $0x1737,(%esp)
...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
     20e:	c7 44 24 04 54 17 00 	movl   $0x1754,0x4(%esp)
     215:	00 
     ...
     285:	e9 ae 00 00 00       	jmp    338 <main+0xd2>
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     291:	00 
     292:	c7 04 24 57 17 00 00 	movl   $0x1757,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     2ae:	0f b6 05 60 18 00 00 	movzbl 0x1860,%eax
     2b5:	3c 63                	cmp    $0x63,%al
     2b7:	75 5a                	jne    313 <main+0xad>
     2b9:	0f b6 05 61 18 00 00 	movzbl 0x1861,%eax
     2c0:	3c 64                	cmp    $0x64,%al
     2c2:	75 4f                	jne    313 <main+0xad>
     2c4:	0f b6 05 62 18 00 00 	movzbl 0x1862,%eax
     2cb:	3c 20                	cmp    $0x20,%al
     2cd:	75 44                	jne    313 <main+0xad>
      // Clumsy but will have to do for now.
      // Chdir has no effect on the parent if run in the child.
      buf[strlen(buf)-1] = 0;  // chop \n
     2cf:	c7 04 24 60 18 00 00 	movl   $0x1860,(%esp)
     2d6:	e8 b6 0a 00 00       	call   d91 <strlen>
     2db:	83 e8 01             	sub    $0x1,%eax
     2de:	c6 80 60 18 00 00 00 	movb   $0x0,0x1860(%eax)
      if(chdir(buf+3) < 0)
     2e5:	c7 04 24 63 18 00 00 	movl   $0x1863,(%esp)
     2ec:	e8 db 0c 00 00       	call   fcc <chdir>
     2f1:	85 c0                	test   %eax,%eax
     2f3:	79 42                	jns    337 <main+0xd1>
        printf(2, "cannot cd %s\n", buf+3);
     2f5:	c7 44 24 08 63 18 00 	movl   $0x1863,0x8(%esp)
     2fc:	00 
     2fd:	c7 44 24 04 5f 17 00 	movl   $0x175f,0x4(%esp)
     304:	00 
    ...
    if(fork1() == 0)
     ...
     31a:	75 14                	jne    330 <main+0xca>
      runcmd(parsecmd(buf));
     31c:	c7 04 24 60 18 00 00 	movl   $0x1860,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     33f:	00 
     340:	c7 04 24 60 18 00 00 	movl   $0x1860,(%esp)
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     366:	c7 44 24 04 6d 17 00 	movl   $0x176d,0x4(%esp)
     36d:	00 
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     393:	c7 04 24 71 17 00 00 	movl   $0x1771,(%esp)
     ...
     544:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     55d:	c7 04 24 34 18 00 00 	movl   $0x1834,(%esp)
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     600:	c7 04 24 34 18 00 00 	movl   $0x1834,(%esp)
     ...
     61d:	c7 04 24 3a 18 00 00 	movl   $0x183a,(%esp)
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     65c:	c7 04 24 34 18 00 00 	movl   $0x1834,(%esp)
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6a2:	c7 04 24 34 18 00 00 	movl   $0x1834,(%esp)
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     71e:	c7 44 24 08 76 17 00 	movl   $0x1776,0x8(%esp)
     725:	00 
  ...
  if(s != es){
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     747:	c7 44 24 04 77 17 00 	movl   $0x1777,0x4(%esp)
     74e:	00 
     74f:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     756:	e8 9a 09 00 00       	call   10f5 <printf>
    panic("syntax");
     75b:	c7 04 24 86 17 00 00 	movl   $0x1786,(%esp)
...
parseline(char **ps, char *es)
{
  ...
  cmd = parsepipe(ps, es);
  while(peek(ps, es, "&")){
     7c8:	c7 44 24 08 8d 17 00 	movl   $0x178d,0x8(%esp)
     7cf:	00 
  ...
  if(peek(ps, es, ";")){
     7e6:	c7 44 24 08 8f 17 00 	movl   $0x178f,0x8(%esp)
     7ed:	00 
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     86a:	c7 44 24 08 91 17 00 	movl   $0x1791,0x8(%esp)
     871:	00 
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     928:	c7 04 24 93 17 00 00 	movl   $0x1793,(%esp)
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     9d3:	c7 44 24 08 b0 17 00 	movl   $0x17b0,0x8(%esp)
     9da:	00 
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     a00:	c7 44 24 08 b3 17 00 	movl   $0x17b3,0x8(%esp)
     a07:	00 
    ...
    panic("parseblock");
     a1e:	c7 04 24 b5 17 00 00 	movl   $0x17b5,(%esp)
  ...
  if(!peek(ps, es, ")"))
     a61:	c7 44 24 08 c0 17 00 	movl   $0x17c0,0x8(%esp)
     a68:	00 
    ...
    panic("syntax - missing )");
     a7f:	c7 04 24 c2 17 00 00 	movl   $0x17c2,(%esp)
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ad4:	c7 44 24 08 b3 17 00 	movl   $0x17b3,0x8(%esp)
     adb:	00 
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     b70:	74 0c                	je     b7e <parseexec+0xb0>
      panic("syntax");
     b72:	c7 04 24 86 17 00 00 	movl   $0x1786,(%esp)
    ...
    if(argc >= MAXARGS)
     ...
     ba3:	7e 0c                	jle    bb1 <parseexec+0xe3>
      panic("too many args");
     ba5:	c7 04 24 d5 17 00 00 	movl   $0x17d5,(%esp)
  ...
  ret = parseredirs(ret, ps, es);
  while(!peek(ps, es, "|)&;")){
     bcd:	c7 44 24 08 e3 17 00 	movl   $0x17e3,0x8(%esp)
     bd4:	00 
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     c3a:	8b 04 85 e8 17 00 00 	mov    0x17e8(,%eax,4),%eax
     c41:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    108e:	0f b6 80 44 18 00 00 	movzbl 0x1844(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    11ec:	75 27                	jne    1215 <printf+0x120>
          s = "(null)";
    11ee:	c7 45 e4 00 18 00 00 	movl   $0x1800,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    12bb:	a1 cc 18 00 00       	mov    0x18cc,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    137c:	a3 cc 18 00 00       	mov    %eax,0x18cc
}
    1381:	c9                   	leave  
    1382:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    13d4:	a1 cc 18 00 00       	mov    0x18cc,%eax
}
    13d9:	c9                   	leave  
    13da:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    13f0:	a1 cc 18 00 00       	mov    0x18cc,%eax
    13f5:	89 45 f0             	mov    %eax,-0x10(%ebp)
    13f8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    13fc:	75 23                	jne    1421 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    13fe:	c7 45 f0 c4 18 00 00 	movl   $0x18c4,-0x10(%ebp)
    1405:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1408:	a3 cc 18 00 00       	mov    %eax,0x18cc
    140d:	a1 cc 18 00 00       	mov    0x18cc,%eax
    1412:	a3 c4 18 00 00       	mov    %eax,0x18c4
    base.s.size = 0;
    1417:	c7 05 c8 18 00 00 00 	movl   $0x0,0x18c8
    141e:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1474:	a3 cc 18 00 00       	mov    %eax,0x18cc
      return (void*)(p + 1);
    ...
    if(p == freep)
    1481:	a1 cc 18 00 00       	mov    0x18cc,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
   ...
   // printf(1,"start routine addr : %d\n",(uint)start_routine);
    ...
    1560:	c7 44 24 04 07 18 00 	movl   $0x1807,0x4(%esp)
    1567:	00 
    ...
    15a5:	c7 44 24 04 15 18 00 	movl   $0x1815,0x4(%esp)
    15ac:	00 
    ...
    15d1:	c7 44 24 04 22 18 00 	movl   $0x1822,0x4(%esp)
    15d8:	00 
...
void init_q(struct queue *q){
    ...
    15f2:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    q->head = 0;
    15f8:	8b 45 08             	mov    0x8(%ebp),%eax
    15fb:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    q->tail = 0;
    1602:	8b 45 08             	mov    0x8(%ebp),%eax
    1605:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
    160c:	5d                   	pop    %ebp
    160d:	c3                   	ret    
...
int empty_q(struct queue *q){
    166e:	55                   	push   %ebp
    166f:	89 e5                	mov    %esp,%ebp
    if(q->size == 0)
    1671:	8b 45 08             	mov    0x8(%ebp),%eax
    1674:	8b 00                	mov    (%eax),%eax
    1676:	85 c0                	test   %eax,%eax
    1678:	75 07                	jne    1681 <empty_q+0x13>
        return 1;
    167a:	b8 01 00 00 00       	mov    $0x1,%eax
    167f:	eb 05                	jmp    1686 <empty_q+0x18>
    else
        return 0;
...
int pop_q(struct queue *q){
    ...
    16c6:	e8 e1 fb ff ff       	call   12ac <free>
       q->size--;
    16cb:	8b 45 08             	mov    0x8(%ebp),%eax
    16ce:	8b 00                	mov    (%eax),%eax
    16d0:	8d 50 ff             	lea    -0x1(%eax),%edx
    ...
    16df:	75 14                	jne    16f5 <pop_q+0x6d>
            q->head = 0;
    16e1:	8b 45 08             	mov    0x8(%ebp),%eax
    16e4:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
            q->tail = 0;
    16eb:	8b 45 08             	mov    0x8(%ebp),%eax
    16ee:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
       }
       return val;
    16f5:	8b 45 f0             	mov    -0x10(%ebp),%eax
    16f8:	eb 05                	jmp    16ff <pop_q+0x77>
    }
    return -1;
    16fa:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
    16ff:	c9                   	leave  
    1700:	c3                   	ret    
